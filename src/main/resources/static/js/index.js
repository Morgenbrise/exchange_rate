...
const countryChangeApi = (value) => {
    return fetch(`/exchange-rate/USD/${value}`)
        ...
        .then(json => exchangeRateAmount.innerHTML = roundToTwo(json.money))
...
const fn_calculation = () => {
    ...
    return roundToTwo(parseFloat(_price) * parseFloat(_exchangeRate)).toFixed(2);
}
